...
<head>
    ...
    <title>New Century Platform - Admin Dashboard</title>
...
<body class="sticky-header">
        ...
        <div class="sidebar-left">
            ...
            <div class="logo dark-logo-bg visible-xs-* visible-sm-*">
                <a href="{{URL::to('/')}}/admin">
                    ...
                    <span class="brand-name">New Century</span>
                </a>
            </div>
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li @if (Request::is('admin')) class="active" @endif><a href="{{URL::to('/admin')}}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    <li class="menu-list<?php echo (Request::segment(2) == 'shows') ? ' active' : ''; ?>">
                        <a href=""><i class="fa fa-users"></i>  <span>Shows</span></a>
                        <ul class="child-list">
                            <li <?php echo (Request::is('admin/shows/create')) ? ' class="active"' : ''; ?>><a href="{{URL::to('/')}}/admin/shows/create">New Show</a></li>
                            <li <?php echo (Request::is('admin/shows')) ? ' class="active"' : ''; ?>><a href="{{URL::to('admin/shows')}}">All Shows</a></li>
                        </ul>
                    </li>
                    <li class="menu-list<?php echo (Request::segment(2) == 'movies') ? ' active' : ''; ?>">
                        <a href=""><i class="fa fa-users"></i>  <span>Videos</span></a>
                        <ul class="child-list">
                            <li <?php echo (Request::is('admin/videos/create')) ? ' class="active"' : ''; ?>><a href="{{URL::to('/')}}/admin/videos/create"> New Video</a></li>
                            <li <?php echo (Request::is('admin/videos')) ? ' class="active"' : ''; ?>><a href="{{URL::to('admin/videos')}}"> All Videos</a></li>
                        </ul>
                    </li>
                </ul>
                <!--sidebar nav end-->
            ...
            <div class="header-section">
                ...
                <div class="logo dark-logo-bg hidden-xs hidden-sm">
                    <a href="{{ URL::to('/admin/') }}" target="_blank">
                        <span class="brand-name">New Century Platform</span>
                    </a>
                </div>
    ...
    <!--dropzone-->
    <script type="text/javascript" src="{{URL::to('/')}}/backend/js/dropzone.js"></script>
